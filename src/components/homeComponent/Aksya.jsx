...
const praducts = [
    {
      ...
      price: 4852000,
      aksya: 4500000,
      info: 'Подробное инфо о кресле 1 qhblqhwlwb  clwje clwwl cwlc nwej cwljec wljeclwbje clbweclb welbc ',
      img: '/chai.png',
    },
    {
  ...
  return (
    ...
    <div className="w-full h-[600px] md:h-[620px]  max-w-[1250px] text-white mx-auto">
      <div className="w-full p-5">
        <h1 className="font-[600] mb-5 text-[18px] md:text-[40px] ">Акции</h1>
